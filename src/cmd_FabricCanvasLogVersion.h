//
#ifndef SRC_CMD_FABRICCANVASLOGVERSION_H_
#define SRC_CMD_FABRICCANVASLOGVERSION_H_

#define SERVER_NAME_FabricCanvasLogVersion "FabricCanvasLogVersion"

namespace FabricCanvasLogVersion
{
  class Command : public CLxBasicCommand
  {
   public:
    ...
    static void initialize(void)
    {
      ...
      lx:: AddServer            (SERVER_NAME_FabricCanvasLogVersion, srv);
    };
...
#endif  // SRC_CMD_FABRICCANVASLOGVERSION_H_
